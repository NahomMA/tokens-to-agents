...
| 2 | [Embeddings](parts/02-embeddings)                   | Word vectors two ways — counting (PPMI + SVD) vs predicting (skip-gram) — and counting wins     | ✅[article](https://medium.com/@nahombirhan/the-1990s-method-that-beat-my-neural-network-25e3e032f405) ✅[Demo](https://huggingface.co/spaces/Nahom-M/tokens-to-agents-02-embeddings)|
